...
void initGLCD(void){
    ...
    /* Configure pixel interface format. */
    ...
    __IDMOFF(); // Force exit from idle mode
    
    __NORON(); // Force normal display mode
    ...
    __DISPON(); // Turn on display (enable output from frame memory)
