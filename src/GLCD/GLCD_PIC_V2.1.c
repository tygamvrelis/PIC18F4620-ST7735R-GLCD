 ...
 *
 * ST7735R-driven 128 x 128 GLCD, V2.1 red PCB
 */
...
void glcdDrawRectangle(unsigned char XS, unsigned char XE,\
     ...
     * two rotation settings: origin top-left and origin top-right. When the
     * origin is set at the top-left or top-right (relative to when the GLCD is
     * placed on the DevBugger, the RAM location corresponding to 
     * (y, x) = (0, 0) is not pixel-mapped on our display panel. 
